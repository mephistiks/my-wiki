...
Данный файл является очень важным для всех кто работает в жизни больше чем над одним проектом.
...
!!! Осторожно
    ...
    Приужно понимать что здесь имеется разница, при инсталле у вас левые либы не стираются которые вы установили просто через пип а не через файл, а при синке всё что не указано в файле удаляется, но оно и правильно.
